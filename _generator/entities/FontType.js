...
var FontType = function(raw) {
  // Call parent constructor
  Entity.call(this, raw);

  // Set color-specific entity properties
  this.type = "Color";
  this.fillable = ['fontType', 'section', 'description', 'deprecated'];
  ...
  return {
    name: raw.descriptor,
    type: 'fontType',
    section: 'FontTypes > ' + this.getSection(),
...
FontType.prototype = Object.create(Entity.prototype);
